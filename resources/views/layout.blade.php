                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{URL::to('/')}}"><img src="{{asset('/fontend/images/home/logo.png')}}" alt="" /></a>
                        </div>
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                         ...
                         <?php 
                         $all_publushed_category=DB::table('tbl_category')
                         ->where('pub_status', 1)
                         ->get();
            
                           foreach($all_publushed_category as $cat_category){ ?>   
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('/product_by_category/'.$cat_category->category_id)}}">{{$cat_category->category_name}}</a></h4>
                                </div>
                            </div>
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name"> 
                                <ul class="nav nav-pills nav-stacked">
                                    <?php 
                                    $all_publushed_brand=DB::table('tbl_brand')
                                    ->where('pub_status', 1)
                                    ->get();
                                    foreach($all_publushed_brand as $cat_brand){ ?> 
                                    <li><a href="{{URL::to('/product_by_manufacture/'.$cat_brand->brand_id)}}"> <span class="pull-right">(50)</span>{{$cat_brand->brand_name}}</a></li>
                                     <?php }?>
                                </ul>
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('/fontend/images/home/iframe2.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('/fontend/images/home/iframe3.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('/fontend/images/home/iframe4.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
