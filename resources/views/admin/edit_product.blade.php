      ...
      enctype="multipart/form-data">
        ...
        <div class="control-group">
            ...
            <select id="selectError3" name="category_id"> 
                       <?php
                           $all_published_category=DB::table('tbl_category')
                                                  ...
                                                  ->get();
                       ?>
                   @foreach($all_published_category as $cat_product){?>  

          <option value="{{$cat_product->category_id}}">
          ...
          <div class="controls">
           ...
           @foreach($product_info as $cat_product){?>  
          <option value="{{$product_info->brand_id}}">
