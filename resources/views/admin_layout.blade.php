...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>IShop Admin Template</title>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Posts</a>
							<ul>
								<li><a class="submenu" href="{{URL::to('cadd-category')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Category</span></a></li>
								<li><a class="submenu" href="{{URL::to('call-post')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Category</span></a></li>
								<li><a class="submenu" href="{{URL::to('add-post')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Post</span></a></li>
								<li><a class="submenu" href="{{URL::to('all-post')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">All Post</span></a></li>
							</ul>	
						</li>
